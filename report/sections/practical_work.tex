...
implemented in TypeScript using the Node.js framework. TypeScript was chosen as it compiles into JavaScript while adding
compile-time type checking similar to statically typed languages such as Java. This would allow for the same language
