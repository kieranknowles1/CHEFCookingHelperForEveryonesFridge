...
the front and back ends, while adding compile-time type checking similar to strongly typed languages such as Java that
is effective at preventing bugs from being introduced, especially when checks for \texttt{null} and \texttt{undefined} are
enabled.~\cite{gao_type_2017}

\section{Backend Implementation}
\todo{Backend}

% TODO: Put this in above section
...
% be added as needed for different endpoints.
...
% TODO: Talked about this earlier
% TypeScript was configured with the \codelisting{strict} option enabled. This enables additional error checking over the
% default configuration, such as by disallowing passing a value that could be null to a function unless the function
