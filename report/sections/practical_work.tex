...
The backend of the \chef{} app was the first component to be implemented, with endpoints created according to the requirements such that the
frontend would have an API to fetch data from. This saved time as there was no need to create dummy data for the recipes.
