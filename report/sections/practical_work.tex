...
The application is tested using the Mocha test framework \cite{noauthor_mocha_nodate} with coverage reports generated by Istanbul \cite{noauthor_istanbul_nodate}.
