...
implemented in TypeScript using the Node.js runtime. TypeScript was chosen as it compiles into JavaScript which can run in web browsers
...
and to instead rely only on interfaces. This simplified the database code and allowed for specialised subtypes to easily
...
React was chosen as it allows for quickly producing a user interface containing
