...
Despite these limitations, the similar recipe suggestion algorithm appears to be an effective
method of finding new recipes.

\subsubsection{Recipe Search}
\todo{Recipe search, based on same model as similar}

Recipe searching is implemented nearly identically to the similar recipe comparison, only differing in that
...
Because of this, searching for \enquote*{pasta} would yield different results to searching \enquote*{Pasta}.
