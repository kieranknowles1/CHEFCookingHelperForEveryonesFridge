...
The \codelisting{fraction.js} package used to parse ingredient amounts could not be imported at first due to it
being packaged as an ECMAScript module while the backend is written in CommonJS. For unknown reasons, adding the
\codelisting{mathjs} package allowed for \codelisting{fraction.js} to be imported without issue.
