...
\subsection{Choice of Language}\label{sec:language}
...
\todo{Specify why Node was chosen over other languages. Positives and negatives of each.}
Multiple languages and frameworks were considered for the backend including
C\#, Python, Node, and PHP.\@ It was eventually decided to use Node as it would
allow using the same language and libraries as the frontend.
...
to be flexible in this regard, as the setup script is the only component to interact with the dataset.
\todo{Requirement number}
...
name would be considered identical. It was decided therefore to only include recipes with any given name
