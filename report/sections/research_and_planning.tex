...
recipes that users lacked ingredients for. See figure \ref{rev:review_missing_ingredients}
(page \pageref{rev:review_missing_ingredients}) for an example.

Another user found that MyFridgeFood gave them suggestions that were too similar to each
other. See figure \ref{rev:review_lack_variety} (page \pageref{rev:review_lack_variety}) for the review.
