...
\begin{table}[h!]
    \begin{tabulary}{\textwidth}{|l|L|l|l|}
        ...
        \requirement{
            \textbf{Scan ingredients.} The system \textbf{should} allow for scanning the barcodes of ingredients to add
            them to the user's \virtualfridge
        }{
            TODO: Source
        }{
            Should-have
...
\begin{table}[h!]
    \begin{tabulary}{\textwidth}{|l|L|l|l|}
        \hline
        \multicolumn{4}{|c|}{\textbf{Non-functional Requirements}} \\\hline
        \textbf{ID} & \textbf{Requirement} & \textbf{Source} & \textbf{Priority} \\\hline
