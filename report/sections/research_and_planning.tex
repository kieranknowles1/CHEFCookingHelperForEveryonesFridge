...
React is a JavaScript-based frontend library

\todo{Node}
Unlike the other frameworks discussed, which run server-side, React is purely a client-side library and thus
