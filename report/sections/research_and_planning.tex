...
The user reviews of the analyzed competitors were consulted which found the following issues:
...
\begin{figure}[h!]
    ...
    \caption{A user review complaining about MyFridgeFood suggesting recipes for which they lacked ingredients}
