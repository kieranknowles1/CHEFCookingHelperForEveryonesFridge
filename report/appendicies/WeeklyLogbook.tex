...
It is recommended that you use the "Navigation Pane" in Word to provide easy and quick access to each respective
log form and/or other component.  On the top menu, simply select "View" and tick the "Navigation Pane" box, which
is located in the "Show" section towards the left-hand side.
