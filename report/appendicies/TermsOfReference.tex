...
\todo{Objectives}
% Specific and measurable goals that outline what will be acomplished. Derived from the aims and serve as building blocks of the project
% Should be:
%   Specific, clear and precice
%   Measurable for when it has been acomplished
%   Acheivablwe, realistic with constraints
%   Relevant to the aims of the project
%   Time-bound, give a deadline that is inline with the Gantt chart
...
\ifSubfilesClassLoaded{
    \todo{Include ethics form here}
}{
    See the \hyperref[sec:ethics_approval]{Ethics Approval} appendix.
}
