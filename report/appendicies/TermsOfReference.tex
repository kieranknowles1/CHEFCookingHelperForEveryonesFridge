...
\begin{ganttchart}[hgrid, vgrid]{6}{12}
    ...
    \ganttlink[link type=r!]{find_data_sources}{requirements}
    \ganttlink[link type=r!]{research_ingredient_scan}{requirements}

    \ganttmilestone[name=implementation]{Start Implementation}{9} \\
    \ganttlink{requirements}{implementation}

    \ganttbar[name=track_ingredients]{Track Ingredients}{10}{10} \\
    \ganttlink{implementation}{track_ingredients}

    \ganttbar[name=suggest_recipes]{Suggest Recipes}{11}{12}
    \ganttlink{track_ingredients}{suggest_recipes}
\end{ganttchart}

\todo{2024 gantt chart}
\begin{ganttchart}[hgrid, vgrid]{1}{16}
    \gantttitle{January to Submission}{16} \\
    \gantttitlelist{1,...,16}{1} \\
\end{ganttchart}

\todo{Should I explain tasks in detail?}
\todoinline{
