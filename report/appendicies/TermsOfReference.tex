...
% Print bibliography on the same page
% From biblatex docs
...
This project aims to create a web application that tracks what ingredients the user has, then suggests recipes that can be made with those ingredients.
...
\todo{Research existing solutions}
