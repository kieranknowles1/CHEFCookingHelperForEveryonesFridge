...
\todo{Proofread this and next paragraph}
\todo{Mention the plan for comp analysis and talk about it in the dissertation. Talk about how it has been started in the reiview}
\todo{Should competitor analysis go in the main report?}
...
\todo{Have a table listing what has been done to justify the requirements}
The background research has led to the following requirements for the \chef{} app:
\todo{Should requirements be in the main report?}
...
\ifSubfilesClassLoaded{
    ...
    See the \hyperref[sec:references]{References} section of the main report for the main reference list, including those that were consulted when preparing the TOR.
}
