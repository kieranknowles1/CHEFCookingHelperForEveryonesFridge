...
\todoinline{
    ...
    This is a statement signed by yourself certifying that the report and the work described in it are your own and that ethical guidelines have been followed,
    and stating what may happen to the report. A copy appears as an appendix to this handbook: you should read it carefully, then include a signed copy in your report.
    You are advised to read the University's regulations concerning plagiarism and collusion, and follow the Ethics guidance outlined in this handbook. You must provide a
    word count: this includes only your report chapters, not the appendices, reference list or abstract.
}
